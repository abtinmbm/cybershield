...
class ForumPost(models.Model):
    ...
    dislikes = models.ManyToManyField(
        CustomUser, related_name="post_dislikes", blank=True
    )
...
class ForumReply(models.Model):
    ...
    dislikes = models.ManyToManyField(
        CustomUser, related_name="reply_dislikes", blank=True
    )
...
class Moderator(models.Model):
    ...
    def __str__(self):
        # Return the username as a string instead of returning the CustomUser object
        return str(self.username.username) if self.username else "Unknown Moderator"
