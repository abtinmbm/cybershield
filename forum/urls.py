...
from .views import (
    signup, add_reply, login_view, terms_conditions, forum_list, create_forum, 
    forum_list_json, logout_view, moderator_form, like_comment, delete_discussion, 
    delete_comment, add_comment, view_discussion
)
